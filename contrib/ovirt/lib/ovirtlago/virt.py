...
class EngineVM(lago.virt.VM):
    ...
    def _artifact_paths(self):
        artifacts = super(EngineVM, self)._artifact_paths()
        return artifacts + ['/var/log/ovirt-engine', ]
...
class HostVM(lago.virt.VM):
    def _artifact_paths(self):
        artifacts = super(HostVM, self)._artifact_paths()
        return artifacts + ['/var/log/vdsm', ]
